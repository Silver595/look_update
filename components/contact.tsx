...
import Cubes from "@/context/Cubes";
import MagnetLines from "@/context/MagnetLines";
import PixelTransition from "@/context/PixelTransition";
import DotGrid from "@/context/DotGrid";
export default function Contact() {
  ...
  return (
    <motion.section
      id="contact"
      ref={ref}
      className="mb-20 sm:mb-28 w-full max-w-7xl mx-auto text-center px-4"
      initial={{
        opacity: 0,
        y: 50,
        scale: 0.95
    ...
    >
      ...
      <motion.div
        className="relative -mt-6 mb-10 max-w-4xl mx-auto"
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start justify-center max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative p-8 rounded-3xl bg-black/90 backdrop-blur-xl border border-white/10
                        shadow-2xl shadow-black/40 overflow-hidden h-[600px] flex flex-col
            ...
            <form
              className="flex flex-col relative z-10 h-full justify-between"
            ...
            >
              <div className="flex-1 flex flex-col">
                ...
                >
                  <motion.textarea
                    className="w-full h-full min-h-[280px] p-6 rounded-xl bg-black/70 backdrop-blur-lg border border-white/20
        ...
        {/* Cubes Section - Right Side - Simplified */}
